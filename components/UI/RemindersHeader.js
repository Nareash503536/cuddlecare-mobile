...
export default function ReminderHeader(props){
    ...
    return(
        <View className={"flex flex-row w-full justify-between items-center px-6 py-2 my-3 border-b border-primary"}>
            ...
            <View className={"flex flex-col items-center ml-5"}>
                <Text className={"font-bold"}>Reminder Activity</Text>
                <Text>Baby Name</Text>
            </View>
            <Image className={"h-8 w-8"} source={require("../../assets/images/Reminder.png")} />
        </View>
    )}
...
export function DateTimePicker ({inputHandler,mode,lable,invalid,minimumDate,minimumTime, initialValue}) {
    ...
    useEffect(() => {
        if(initialValue){
            initialValue = initialValue.slice(12, 16);
            setDateTimePicker(initialValue);
        }
    }, [initialValue]);

...
export const BottleFeedingTimeline = () => {
    ...
    const getFeeding = async () => {
        ...
        const apiURL = BASE_URL + "/bottlefeeding/allDate";
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                feedingDetails.forEach((feeding) => {
                    let icon = require("../../../assets/images/pumped.png");
                    setFeedingData((prevFeedingData) => [...prevFeedingData, {
                        time: feeding.feedingDate.split("T")[0],
                        title: feeding.feedingType,
                        description: "Quantity: "+feeding.quantity+" ml\nTime: "+feeding.feedingTime,
                        icon: icon,

                    }]);
                });
                console.log("all feeding",feedingData.length == 0);
            } catch (error) {

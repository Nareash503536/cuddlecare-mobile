...
export default function GivenVaccines() {
    const { vaccinationsGiven, loading } = useContext(VaccineContext);
            ...
            vaccinationsGiven.length === 0 ?
                (
                    <View className={"m-auto items-center"}>
                        ...
                        <Text className="text-center" style={{ color: "grey" }}>Sorry... No vaccinations given to the baby</Text>
                    </View>) :
                (
                    <View

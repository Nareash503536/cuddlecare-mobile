...
export default function MissedVaccines() {

    const { vaccinationsMissed, loading } = useContext(VaccineContext);
            ...
            vaccinationsMissed.length === 0 ?
                (
                    <View className={"m-auto items-center"}>
                        ...
                        <Text className="text-center" style={{ color: "grey" }}>Sorry... No vaccinations have missed</Text>
                    </View>) :
                (
                    <View
